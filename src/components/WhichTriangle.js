  ...
  return (
    <div className="game-4">
      ...
      <div className="description">
        ...
        <p>
          Three angles will be displayed and you have to answer whether it is a
          right-angled triangle, acute-angled triangle or an obtuse-angled
          triangle
        </p>
      </div>
