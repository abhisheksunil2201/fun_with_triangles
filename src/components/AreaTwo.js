  ...
  function calculateArea(e) {
    ...
    if (a > 0 && b > 0 && c > 0) {
      ...
      if (s > a && s > b && s > c) {
        ...
        setArea("");
        setText(
          "Please enter correct sides, the sides of a triangle cannot be greater than or equal to its semi-perimeter"
        );
      }
    } else {
      setArea("");
